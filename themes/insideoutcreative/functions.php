...
add_action('wp_enqueue_scripts', 'ikarda_stylesheets');
// for footer
function ikarda_stylesheets_footer() {
...
add_action('get_footer', 'ikarda_stylesheets_footer');
...
add_action('after_setup_theme', 'ikarda_menus');
